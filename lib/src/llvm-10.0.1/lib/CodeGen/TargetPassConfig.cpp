...
static cl::opt<unsigned>
    CodePointerHidingOpt("code-pointer-hiding",
                         cl::desc("Enable Code Pointer Hiding"),
                         cl::value_desc("max-sled-size"), cl::init<unsigned>(0), cl::Hidden);
...
void TargetPassConfig::addMachinePasses() {
  ...
  if(CodePointerHidingOpt.getValue() > 0) {
    addPass(createMachineFunctionCodePointerHidingPass(CodePointerHidingOpt.getValue()));
  }
