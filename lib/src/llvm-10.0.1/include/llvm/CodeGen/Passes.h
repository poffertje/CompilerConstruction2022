...
/// MachineDominanaceFrontier - This pass is a machine dominators analysis pass.
  ...
  /// Coco register allocator.
  extern char &RACocoID;
  ...
  /// CocoRegisterAllocation Pass - This pass implements the coco register allocator
  ///
  FunctionPass *createCocoRegisterAllocator();
